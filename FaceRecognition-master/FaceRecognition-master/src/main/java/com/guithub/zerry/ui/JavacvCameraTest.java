...
import com.github.wihohoo.TrainerTest;
...
public class JavacvCameraTest {
	...
	public static void train() throws Exception {
        ...
        String john1 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/s2/1.pgm";
        String john2 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/s2/2.pgm";
        String john3 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/s2/3.pgm";
        String john4 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/s2/4.pgm";

        String smith1 = "faces/s4/1.pgm";
        String smith2 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/s4/2.pgm";
        String smith3 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/s4/3.pgm";
        String smith4 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/s4/4.pgm";

        String zerry1 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/myface/1.pgm";
        String zerry2 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/myface/2.pgm";
        String zerry3 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/myface/3.pgm";
        String zerry4 = "/Users/zhuzirui/Downloads/FaceRecognition-master/src/test/resources/faces/myface/4.pgm";
		...
		while (true) {
			...
			if (frame != null) {
				...
				for (int i = 0; i < total; i++) {
					CvRect temp = new CvRect(cvGetSeqElem(faces, i));
					int w = temp.width(), h = temp.height();
					if (r == null || (w > temp.width() && h > temp.height()) ) {
						r = temp;
					}
					temp.close();
				}
				...
				// 若解决不了矩阵维数问题，则用opencv自带recognition
				String person = detect("/Users/zhuzirui/Downloads/FaceRecognition-master/target.pgm");
