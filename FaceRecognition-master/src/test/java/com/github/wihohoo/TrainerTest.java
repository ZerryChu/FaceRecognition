...
public class TrainerTest {
    ...
    public void testTraining() throws Exception {
        ...
        */
        ...
        String smith1 = "faces/myface/1.pgm";
        String smith2 = "faces/myface/2.pgm";
        String smith3 = "faces/myface/3.pgm";
        String smith5 = "faces/myface/5.pgm";
        ...
        trainer.add(convertToMatrix(smith1), "zerry");
        trainer.add(convertToMatrix(smith2), "zerry");
        trainer.add(convertToMatrix(smith3), "zerry");
        
        // train
        trainer.train();

        // recognize
        assertEquals("zerry", trainer.recognize(convertToMatrix(john4)));
